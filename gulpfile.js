...
exports.serve = parallel(
  series(parallel(template), static, sassDev, img, etc, bSync),
  watching
);
...
exports.buildNoImg = parallel(
  series(parallel(template), static, sassDev, etc, bSync),
  watching
);
exports.test = series(
  parallel(template),
...
exports.land = parallel(
  series(parallel(template), static, sassDev, img, etc, bSyncLanding),
  watching
);
